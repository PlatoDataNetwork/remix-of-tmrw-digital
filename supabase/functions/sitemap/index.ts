...
const STATIC_PAGES = [
  ...
  { path: "/intelligence", changefreq: "hourly", priority: "0.9" },
  ...
  // Blog
  { path: "/intelligence/rwa-tokenization", changefreq: "monthly", priority: "0.6" },
  { path: "/intelligence/ai-investor-engagement", changefreq: "monthly", priority: "0.6" },
  { path: "/intelligence/pre-ipo-markets", changefreq: "monthly", priority: "0.6" },
  { path: "/intelligence/carbon-credits-tokenization", changefreq: "monthly", priority: "0.6" },
  { path: "/intelligence/commodities-tokenization", changefreq: "monthly", priority: "0.6" },
  { path: "/intelligence/energy-tokenization", changefreq: "monthly", priority: "0.6" },
  { path: "/intelligence/infrastructure-tokenization", changefreq: "monthly", priority: "0.6" },
  { path: "/intelligence/metals-tokenization", changefreq: "monthly", priority: "0.6" },
  { path: "/intelligence/rare-earth-tokenization", changefreq: "monthly", priority: "0.6" },
  { path: "/intelligence/real-estate-tokenization", changefreq: "monthly", priority: "0.6" },
  { path: "/intelligence/sovereign-wealth-tokenization", changefreq: "monthly", priority: "0.6" },
  { path: "/intelligence/tax-credits-tokenization", changefreq: "monthly", priority: "0.6" },
  { path: "/intelligence/collectables-tokenization", changefreq: "monthly", priority: "0.6" },
  { path: "/intelligence/stablecoins-tokenization", changefreq: "monthly", priority: "0.6" },
  { path: "/intelligence/utilities-tokenization", changefreq: "monthly", priority: "0.6" },
  { path: "/intelligence/tmrw-launch", changefreq: "monthly", priority: "0.6" },
];
