  ...
  // 04 — Issuance Fee Examples
  {
    ...
    render: () => (
      <div className="flex flex-col h-full gap-6 justify-center">
        ...
        <SlideTitle>Issuance Revenue at Scale.</SlideTitle>
        <div className="overflow-x-auto">
          <table className="w-full text-xs">
            <thead>
              <tr className="border-b border-[hsl(82,85%,55%,0.15)]">
                <th className="py-2.5 px-3 text-left text-[10px] uppercase tracking-wider font-medium text-foreground">Asset Tokenized</th>
                <th className="py-2.5 px-3 text-right text-[10px] uppercase tracking-wider font-medium text-foreground">Value</th>
                <th className="py-2.5 px-3 text-right text-[10px] uppercase tracking-wider font-medium text-foreground">Fee</th>
                <th className="py-2.5 px-3 text-right text-[10px] uppercase tracking-wider font-medium text-foreground">Revenue</th>
              </tr>
            </thead>
            <tbody>
  ...
  // 07 — Year 5+ Breakout
  {
    ...
    render: () => (
      <div className="flex flex-col h-full gap-6 justify-center">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-5">
            <StatBlock value="$10B+" label="Assets Tokenized" />
            <GreenCard className="space-y-3">
              <SectionLabel>Revenue Estimate</SectionLabel>
              <div className="space-y-2">
                <div className="flex justify-between text-sm font-light"><span className="text-muted-foreground">Issuance</span><span className="text-foreground">~$100M</span></div>
                <div className="flex justify-between text-sm font-light"><span className="text-muted-foreground">Servicing</span><span className="text-foreground">~$25M</span></div>
                <div className="w-full h-px bg-border/30" />
                <div className="flex justify-between text-sm font-medium"><span className="text-foreground">Total</span><span className="text-[hsl(82,85%,55%)]">≈ $120M+</span></div>
              </div>
            </GreenCard>
          </div>
          <div className="flex flex-col items-center justify-center">
            <GreenCard className="w-full text-center py-8">
              <SectionLabel>Implied Valuation</SectionLabel>
              <div className="text-5xl font-extralight text-[hsl(82,85%,55%)] mt-3">$1B – $3B</div>
            </GreenCard>
          </div>
        </div>
        <SlideNumber n={7} />
...
export default function PathTo1B() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEOHead title="TMRW: Path to Immortality" description="Tomorrow Digital path to immortality through tokenized real-world asset infrastructure." path="/path-to-1b" noindex />
      <Navbar />
