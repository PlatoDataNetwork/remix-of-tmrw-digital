...
const MODULE_COLORS: Record<TrademarkModule, string> = {
...
const PROFILES: Record<TrademarkModule, ProfileResult[]> = {
  beginner: [
...
function getProfile(score: number, total: number, mod: TrademarkModule): ProfileResult {
...
function AnalyzingStep({ currentModule }: { currentModule: TrademarkModule }) {
