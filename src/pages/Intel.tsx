...
const articles = [
  ...
  },
  {
    ...
    excerpt: "Tokenized treasuries surpassed $1B+ in 2024. The next frontier isn't tokenization — it's programmable, AI-managed dynamic yields.",
    slug: "/blog/programmable-yield-rwa",
  },
  {
    date: "Mar 2026",
    subject: "Autonomous Markets",
    category: "AI · Web3",
