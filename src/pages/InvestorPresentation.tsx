...
const team = [
  { name: "Justin Hartzman", role: "Chairman", bio: "Serial entrepreneur and capital markets veteran. Co-founded CoinSmart, leading it to a public listing and subsequent sale to WonderFi (TSX:WNDR) Over a decade of experience scaling fintech companies and executing successful go-public strategies across North America." },
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="animated-gradient-capital-bg rounded-2xl overflow-hidden max-w-3xl mx-auto">
            <img src={lotusFlowerImg} alt="Tomorrow Digital RTO" className="w-full h-auto object-cover" />
          </div>
        </div>
      </section>
