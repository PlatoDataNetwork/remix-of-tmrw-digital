    ...
    return { allocations: [...] };
      ...
      <div className={p("supported-networks")}>
        ...
        {[
          ...
          { id: "network-polkadot", name: "Polkadot", desc: "Polkadot is a heterogeneous multi-chain protocol enabling cross-chain interoperability through its relay chain and parachain architecture. W3AI leverages Polkadot's shared security model and XCM messaging for seamless cross-chain AI agent coordination, asset transfers, and governance across its parachain ecosystem.", bullets: ["Relay chain shared security providing economic guarantees across all connected parachains.", "XCM (Cross-Consensus Messaging) enabling native cross-chain AI agent orchestration.", "Substrate framework for custom blockchain logic and rapid protocol development.", "On-chain governance with OpenGov for transparent, community-driven protocol evolution.", "Nominated Proof-of-Stake (NPoS) consensus with high validator decentralization."], links: { github: "https://github.com/paritytech/polkadot-sdk", foundation: "https://web3.foundation", x: "https://x.com/Polkadot", visit: "https://polkadot.com" }},
        ].map(n => (
      ...
      <div className={p("foundations")}>
        ...
        {[
          ...
          { id: "fi-polkadot", name: "Polkadot", desc: "Polkadot is a next-generation blockchain protocol uniting an entire network of purpose-built blockchains, enabling them to operate seamlessly together at scale. Founded by Ethereum co-founder Dr. Gavin Wood, Polkadot's relay chain coordinates consensus and cross-chain messaging across its parachain ecosystem, providing shared security and true interoperability. The Polkadot Foundation and ecosystem grants program have funded hundreds of projects building decentralized infrastructure, making it a cornerstone of the multi-chain future that W3AI is architected to serve.", links: { github: "https://github.com/paritytech/polkadot-sdk", foundation: "https://web3.foundation", x: "https://x.com/Polkadot", visit: "https://polkadot.com" }},
        ].map(f => (
