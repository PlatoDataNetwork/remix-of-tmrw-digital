    ...
    render: () => (
      <div className="flex flex-col justify-center items-center h-full gap-8 max-w-3xl mx-auto relative">
        <div className="text-center space-y-3 w-full">
          <SlideTitle>The Anatomy of an Intelligent Network</SlideTitle>
      ...
      <div className="flex flex-col justify-center h-full gap-6 max-w-3xl mx-auto relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {[
            ...
            { icon: FileCode, title: "Integrated dApp Deployment", desc: "One-click deployment to private testnet with full access control across its lifecycle management." },
    ...
    render: () => (
      <div className="flex flex-col justify-center h-full gap-6 max-w-3xl mx-auto relative">
        <div className="text-center space-y-3">
          ...
          <SlideSubtitle>
            Fueling The Intelligence Economy. One Block at a Time.
            <br />
            Delivering Utility, Stored Value and Community.
          </SlideSubtitle>
        </div>
            ...
            <tbody>
              {[
                ...
                <tr key={f} className="border-b border-border/30">
                  ...
                  <td className="py-2.5 px-3 text-blue-400 text-xs font-light">{a}</td>
                </tr>
              ))}
            </tbody>
          </table>
  ...
  // 18 — Governance
  {
    ...
    render: () => (
      <div className="flex flex-col justify-center h-full gap-8 max-w-3xl mx-auto relative">
        ...
        <div className="text-center"><SlideTitle>W3AI DAO Based Governance</SlideTitle></div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
          {[
      ...
      <div className="flex flex-col items-center justify-center h-full gap-8 max-w-3xl mx-auto relative text-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
          {[
            ...
            <div key={n} className="px-6 py-6 rounded-lg border border-[hsl(82,85%,55%,0.4)] bg-card text-center relative overflow-hidden hover:border-[hsl(82,85%,55%,0.7)] transition-colors">
    ...
    render: () => (
      <div className="flex flex-col justify-center h-full gap-6 max-w-3xl mx-auto relative">
        <div className="text-center space-y-4">
          ...
          <SlideSubtitle>
            From AI Analytics to RWA Compliance, we deliver end-to-end capabilities that drive growth, security, and sustainable value.
          </SlideSubtitle>
        </div>
  ...
  // 24 — Auditing & Compliance
  {
    ...
    render: () => (
      <div className="flex flex-col justify-center h-full gap-8 max-w-3xl mx-auto relative">
        ...
        <div className="text-center"><SlideTitle>W3AI Auditing & Compliance</SlideTitle></div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-12">
          <div className="space-y-4">
  ...
  // Tokenomics
  {
    ...
    render: () => (
      <div className="flex flex-col justify-center h-full gap-6 max-w-4xl mx-auto relative">
        <div className="text-center space-y-2">
          <SlideTitle>W3AI DAO Based Community Strategy</SlideTitle>
    ...
    render: () => (
      <div className="flex flex-col justify-center h-full gap-6 max-w-5xl mx-auto relative px-4">
        ...
        <div className="grid grid-cols-2 gap-6">
          {/* QR 1 */}
          <GreenCard className="p-5 flex items-center gap-5">
            <img
              src="https://api.qrserver.com/v1/create-qr-code/?size=160x160&data=https%3A%2F%2Fgithub.com%2FPlatoDataNetwork&bgcolor=0a0a0a&color=b8e636&format=svg"
              alt="QR code to GitHub"
              className="w-28 h-28 rounded-lg flex-shrink-0"
            />
            <div className="flex flex-col gap-2">
              <svg viewBox="0 0 98 96" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-foreground fill-current">
              ...
              <h3 className="text-sm font-medium text-foreground">PlatoDataNetwork</h3>
              <p className="text-xs font-light text-muted-foreground">Core protocol and smart contract repositories.</p>
            </div>
          </GreenCard>
          {/* QR 2 */}
          <GreenCard className="p-5 flex items-center gap-5">
