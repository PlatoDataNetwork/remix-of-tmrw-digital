            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center px-6 py-8 pb-16 relative">
              ...
              {!isToolbarActive ? (
                <>
                  ...
                  {/* Made for Mac OS — only on welcome slide */}
                  {activeSection === 0 && (
                    <div className="flex items-center gap-2 mt-5">
                      <span className="text-xs md:text-sm uppercase tracking-[0.3em] text-white/40">MADE EXCLUSIVELY FOR</span>
                      <svg viewBox="0 0 384 512" className="h-4 w-4 md:h-5 md:w-5 animated-gradient-icon-bright" style={{
                      ...
                      <span className="text-xs md:text-sm uppercase tracking-[0.3em] text-white/40">MAC OS</span>
                    </div>
                  )}
                </>
              ) : (
