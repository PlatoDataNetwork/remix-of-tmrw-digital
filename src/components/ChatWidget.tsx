    ...
    <>
      ...
      {!open && (
        <motion.button
          ...
          className="fixed bottom-6 right-6 z-[70] h-9 w-9 flex items-center justify-center rounded-full bg-[hsl(240,10%,8%)] border border-white/10 hover:bg-[hsl(240,10%,14%)] transition-colors shadow-lg"
