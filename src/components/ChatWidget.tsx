      ...
      <AnimatePresence>
        {!open && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 z-[60] h-9 w-9 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 hover:scale-105 transition-all"
