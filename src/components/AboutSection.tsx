        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed text-base lg:text-lg font-light">
              With over two decades of proven expertise, our team has inspired hundreds of companies
              through critical growth stages — delivering measurable outcomes backed by deep
              industry knowledge and strategic execution.
            </p>
          </motion.div>
